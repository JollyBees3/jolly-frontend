    ...
    return(
        <section className="signUp">
            <div className="border shadow-lg w-[30%] h-[90%] ml-[55%] flex flex-col" >
                <h1 className="text-[2em] text-center mt-[1em] font-bold mb-[1em]">Sign Up to Library</h1>
                ...
                <input type="text" className="w-[80%] h-[10%] border mb-[1em] ml-[10%] mr-auto" placeholder="Confirm password"/>
                ...
                <Link to="../login" className="font-bold text-[0.9em] text-center text-[#000080] underline">Log In</Link>
