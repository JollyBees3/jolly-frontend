  ...
  return (
    <section className="p-8">
      ...
      <p className="text-lg text-center mb-12">
        Manage your book collection here. You can add, delete, update books, and send reviews for your favorite ones.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-4 shadow-lg rounded-lg flex flex-col items-center">
          <img src={image1} alt="Book 1" className="w-full h-64 object-cover mb-4 rounded" />
          <Link to="/add-new" className="mb-2">
            <button className="bg-blue-800 text-white py-2 px-4 rounded hover:bg-blue-500">Add Book</button>
          </Link>
        ...
        {/* Book 3 */}
        <div className="bg-white p-4 shadow-lg rounded-lg flex flex-col items-center">
          <img src={image3} alt="Book 3" className="w-full h-64 object-cover mb-4 rounded" />
          <Link to="/updatebook" className="mb-2">
            <button className="bg-blue-800 text-white py-2 px-4 rounded hover:bg-blue-500">Update Book</button>
          </Link>
        ...
        {/* Book 4 */}
        <div className="bg-white p-4 shadow-lg rounded-lg flex flex-col items-center">
          <img src={image4} alt="Book 4" className="w-full h-64 object-cover mb-4 rounded" />
          <Link to="/reviews" className="mb-2">
            <button className="bg-blue-800 text-white py-2 px-4 rounded hover:bg-blue-500">Review Book</button>
          </Link>
